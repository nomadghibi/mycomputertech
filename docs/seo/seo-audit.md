...
Important note:
- The primary city for the site should be `Indian Harbour Beach, Florida`.
- The current site NAP shows `296 E Eau Gallie Blvd, Indian Harbour Beach, FL 32937`.
- Keep Satellite Beach as a nearby service area, not the primary identity.
...
High priority:
- NAP / primary-city consistency should stay centered on `Indian Harbour Beach`
...
|---|---|---|---|---:|---|---|---|---|
| `/` | Computer Repair Indian Harbour Beach FL \| My Computer Tech | Computer Repair & IT Support in Indian Harbour Beach FL | My Computer Tech provides practical computer repair, laptop help, Wi-Fi troubleshooting, printer setup, virus removal, refurbished computer sales, and small business IT support for Indian Harbour Beach and nearby Space Coast communities. | 620 | Good topical coverage, but title should stay tightly focused on the primary city. | Indian Harbour Beach should remain the primary local identity; Satellite Beach stays secondary. | Keep homepage centered on Indian Harbour Beach; use nearby cities as supporting areas only. | High |
| `/services` | Indian Harbour Beach Computer Repair Services \| My Computer Tech | Professional beachside computer repair and IT support | Computer repair, laptop repair, virus removal, printer setup, Wi-Fi setup, data transfer, Microsoft 365 help, and onsite support from My Computer Tech in Indian Harbour Beach. | 760 | Strong service list, but no single clear service-focus keyword target per section; page is broad. | City modifiers are better, but location-specific service pages still need crawlable support. | Keep this as a hub page; add stronger internal links to service landing pages; tune headings to include service-intent variants naturally. | High |
| `/service-areas` | Service Areas \| Indian Harbour Beach Computer Repair | Indian Harbour Beach computer repair coverage | My Computer Tech serves Indian Harbour Beach, Satellite Beach, Indialantic, Melbourne Beach, Cocoa Beach, Cape Canaveral, and nearby beachside Space Coast communities. | 540 | Decent area page, but too shallow to rank for individual city terms. | Indian Harbour Beach should stay first; nearby cities should remain secondary support areas. | Build dedicated location pages and link them here; add stronger city-specific supporting copy and FAQ. | High |
| `/about` | About My Computer Tech \| Indian Harbour Beach IT Support | Local beachside computer repair with serious IT support standards | Learn about My Computer Tech, a locally known beachside computer repair and IT support business serving from the same Indian Harbour Beach location since 2010. | 640 | Good trust content, but not optimized as a local entity authority page. | Local trust is strong, but primary city should be more explicit. | Add clearer local entity wording, local service area mentions, and internal links to location/service pages. | Medium |
| `/contact` | Contact My Computer Tech \| Indian Harbour Beach Computer Repair | Request local computer repair or IT support | Contact My Computer Tech for onsite computer repair, printer setup, Wi-Fi help, virus removal, laptop repair, and practical local IT support in Indian Harbour Beach. | 470 | Contact intent is fine, but page can support stronger local conversion phrases. | Indian Harbour Beach should be the main local phrase on the contact page. | Keep working form, add short FAQ and city mention, and ensure NAP consistency with GBP. | Medium |
| `/blog` | Indian Harbour Beach Computer Repair Blog \| My Computer Tech | Indian Harbour Beach computer repair guides for Space Coast communities | Indian Harbour Beach computer repair blog with local Space Coast guides on laptop repair, virus removal, Wi-Fi setup, printer help, and small business IT support. | 260 | Thin archive page; relies on excerpts without strong contextual copy. | Local signals exist but are light. | Add 200-300 words of intro/outro content with internal links to money pages and location pages. | Medium |
