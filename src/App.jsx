...
const pageMeta = {
  ...
  '/services': {
    title: 'Indian Harbour Beach Computer Services | My Computer Tech',
    description:
      'Computer repair, laptop repair, virus removal, printer setup, Wi-Fi setup, data transfer, and onsite support from My Computer Tech in Indian Harbour Beach.',
    keywords:
  ...
  '/service-areas': {
    title: 'Indian Harbour Beach Service Areas | My Computer Tech',
    description:
      'My Computer Tech serves Indian Harbour Beach, Satellite Beach, Indialantic, Melbourne Beach, Cocoa Beach, Cape Canaveral, and nearby beachside communities.',
    keywords:
  ...
  '/about': {
    title: 'About My Computer Tech | Indian Harbour Beach FL',
    description:
      'Learn about My Computer Tech, a local beachside computer repair and IT support business serving Indian Harbour Beach since 2010.',
    keywords:
  ...
  '/contact': {
    title: 'Contact My Computer Tech | Indian Harbour Beach FL',
    description:
      'Contact My Computer Tech for onsite computer repair, printer setup, Wi-Fi help, virus removal, and laptop repair in Indian Harbour Beach.',
    keywords:
  ...
  '/blog': {
    title: 'Computer Repair Blog | Indian Harbour Beach FL',
    description:
      'Indian Harbour Beach computer repair blog with local guides on laptop repair, virus removal, Wi-Fi setup, printer help, and small business IT support.',
    keywords:
