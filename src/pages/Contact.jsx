...
import {
  ...
  FaPhone, FaEnvelope, FaMapMarkerAlt, FaClock, FaCheckCircle,
} from 'react-icons/fa';
...
const inputClass =
  'w-full px-4 py-3 text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition';
    ...
    <div>
      ...
      >
        <div className="container mx-auto text-center px-4">
          <h1 className="mb-4 text-5xl font-bold leading-tight">Contact Best Computer Tech</h1>
          <p className="text-xl opacity-90">Palm Bay &amp; Melbourne, FL — We respond within 1 business day.</p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              {hasPrefillNotice && (
                <div className="p-4 mb-6 text-sm text-blue-800 border border-blue-200 rounded-lg bg-blue-50">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {isBusinessContractPrefill && (
                    <fieldset className="p-5 border border-blue-200 rounded-xl bg-blue-50">
                      <legend className="px-2 text-sm font-bold text-blue-800">Business Contract Quick Select</legend>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <FaPhone className="text-blue-600 mt-1 shrink-0" />
                  <div>
                    <p className="text-xs text-gray-400 font-semibold uppercase tracking-wide">Phone</p>
                    <a href="tel:+13219535199" className="text-gray-800 font-semibold hover:text-blue-600 transition-colors">
                      (321) 953-5199
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:365techoncall@gmail.com" className="text-gray-800 font-semibold hover:text-blue-600 transition-colors break-all">
              ...
              <table className="w-full text-sm text-gray-700">
                <tbody>
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-2 text-right text-green-600 font-semibold">9am – 6pm</td>
                  </tr>
                  <tr className="border-b border-gray-100">
            ...
            <div className="bg-blue-600 rounded-xl shadow-md p-6 text-white text-center">
              <FaCheckCircle className="w-8 h-8 mx-auto mb-3 opacity-90" />
              <p className="font-bold text-lg">We Respond Fast</p>
              <p className="text-sm opacity-90 mt-1">
                We reply to all inquiries within <strong>1 business day</strong> — often the same day.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-100 text-blue-700 hover:bg-blue-600 hover:text-white transition-colors">
                  <FaFacebook className="w-5 h-5" />
                </a>
                <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 flex items-center justify-center rounded-full bg-sky-100 text-sky-500 hover:bg-sky-500 hover:text-white transition-colors">
                  <FaTwitter className="w-5 h-5" />
                </a>
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-100 text-blue-700 hover:bg-blue-700 hover:text-white transition-colors">
                  <FaLinkedin className="w-5 h-5" />
                </a>
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 flex items-center justify-center rounded-full bg-pink-100 text-pink-500 hover:bg-pink-500 hover:text-white transition-colors">
