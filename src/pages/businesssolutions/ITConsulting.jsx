...
//         <p className="mb-4">
//           At Best Computer Tech, we specialize in comprehensive IT consulting services to help your business leverage technology for growth and efficiency. Our certified consultants provide expert advice and customized solutions to meet your specific business needs.
//         </p>
  ...
  return (
    <div>
      <Helmet>
        ...
        <link rel="canonical" href="https://bestcomputertec.com/it-consulting-services" />
      </Helmet>
      <HeroSection title="IT Consulting" image={heroImage} />
      <div className="container p-8 mx-auto">
        <h2 className="mb-4 text-3xl font-semibold">Expert IT Consulting Services</h2>
