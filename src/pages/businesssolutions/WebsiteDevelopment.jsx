    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
          ...
          <p className="mt-3 text-blue-100 text-lg max-w-2xl">Custom, secure, and high-performance websites that establish and grow your online presence.</p>
        </div>
      </section>
      ...
      <section className="bg-white py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 border-l-4 border-blue-600 pl-4">Expert Website Development Services</h2>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
            <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-8 text-white flex flex-col justify-center">
              ...
              <p className="text-blue-100 mb-8">Our Website Development Services are designed to offer you the best support at affordable prices. Contact us today to learn more about our pricing and packages.</p>
