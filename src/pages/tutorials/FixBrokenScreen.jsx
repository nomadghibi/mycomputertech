    ...
    <div>
      ...
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 1: Gather Your Tools</h2>
            <ul className="mb-4 space-y-2 list-disc list-outside pl-6 text-gray-700 marker:text-blue-500">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 2: Power Down and Disconnect</h2>
            <ol className="mb-4 space-y-2 list-decimal list-outside pl-6 text-gray-700 marker:text-blue-600 marker:font-bold">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 3: Remove the Bezel</h2>
            <ol className="mb-4 space-y-2 list-decimal list-outside pl-6 text-gray-700 marker:text-blue-600 marker:font-bold">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 4: Disconnect the Screen</h2>
            <ol className="mb-4 space-y-2 list-decimal list-outside pl-6 text-gray-700 marker:text-blue-600 marker:font-bold">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 5: Install the New Screen</h2>
            <ol className="mb-4 space-y-2 list-decimal list-outside pl-6 text-gray-700 marker:text-blue-600 marker:font-bold">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 6: Reattach the Bezel</h2>
            <ol className="mb-4 space-y-2 list-decimal list-outside pl-6 text-gray-700 marker:text-blue-600 marker:font-bold">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3 border-l-4 border-blue-600 pl-4">Step 7: Test the New Screen</h2>
            <ol className="mb-4 space-y-2 list-decimal list-outside pl-6 text-gray-700 marker:text-blue-600 marker:font-bold">
